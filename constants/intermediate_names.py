...
BASE_ENDOGENOUS_COLUMNS = [
    EU_PREFIX + PC_EU_REGULAR_BEST_PRICE,
    EU_PREFIX + PC_EU_GREEN_BEST_PRICE,
    ASIA_PREFIX + PC_ASIA_REGULAR_BEST_PRICE,
    ASIA_PREFIX + PC_ASIA_GREEN_BEST_PRICE,
]

GROUPED_ENDOGENOUS_COLUMNS = [
